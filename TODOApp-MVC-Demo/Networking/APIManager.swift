...
class APIManager {
    ...
    class func register(with name: String, email: String, password: String, age: Int, completion: @escaping (_ error: Error?, _ registerData: LoginResponse?) -> Void) {
    ...
    class func addTask(with description: String, completion: @escaping (_ error: Error?, _ addTask: AddTaskResponse?) -> Void) {
        ...
        AF.request(URLs.addTask, method: HTTPMethod.post, parameters: params, encoding: JSONEncoding.default, headers: headers).response {
            response in
            guard response.error == nil else {
                print(response.error!)
                completion(response.error, nil)
    ...
    class func getAllTask(completion: @escaping (_ error: Error?, _ alltaskData: GetAllTaskResponse?) -> Void) {
        ...
        AF.request(URLs.getAllTask, method: HTTPMethod.get, parameters: nil, encoding: JSONEncoding.default, headers: headers).response {
            ...
            do {
                let decoder = JSONDecoder()
                let alltaskData = try decoder.decode(GetAllTaskResponse.self, from: data)
    ...
    class func getProfile(completion: @escaping (_ error: Error?, _ profile: UpdateProfileResponse?) -> Void) {
        ...
        AF.request(URLs.getUserProfile, method: HTTPMethod.put, parameters: nil, encoding: JSONEncoding.default, headers: headers).response {
            ...
            do {
                let decoder = JSONDecoder()
                let profile = try decoder.decode(UpdateProfileResponse.self, from: data)
